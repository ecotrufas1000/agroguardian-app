...
if menu == "🛰️ Rend. Inteligente":
    ...
    CULTIVOS = {
        "🌰 Pecán": {
            "gdd_base":    10,
            "gdd_optimo":  (2000, 3000),
            "precip_opt":  (500, 800),
            "frio_horas":  (800, 1200),   # horas frío requeridas
            "estres_temp": 38,            # °C máximo tolerable
            "densidad_def": 400,
            "unidad":      "kg/árbol",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Requiere alta acumulación de calor y buena humedad en llenado de fruto"
        },
        "🍎 Manzano": {
            "gdd_base":    10,
            "gdd_optimo":  (1200, 1800),
            "precip_opt":  (600, 900),
            "frio_horas":  (1000, 1800),
            "estres_temp": 35,
            "densidad_def": 800,
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Alta demanda de frío invernal, sensible a déficit hídrico en cuaje"
        },
        "🍐 Peral": {
            "gdd_base":    7,
            "gdd_optimo":  (1100, 1700),
            "precip_opt":  (500, 800),
            "frio_horas":  (900, 1500),
            "estres_temp": 35,
            "densidad_def": 700,
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Sensible a golpe de calor en floración, requiere buen drenaje"
        },
        "🍑 Duraznero": {
            "gdd_base":    7,
            "gdd_optimo":  (900, 1400),
            ...
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Gran variación varietal en requerimiento de frío"
        },
        "🍒 Cerezo": {
            "gdd_base":    7,
            "gdd_optimo":  (800, 1200),
            "precip_opt":  (400, 700),
            "frio_horas":  (1200, 2000),
            "estres_temp": 32,
            "densidad_def": 500,
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Mayor requerimiento de frío, muy sensible a lluvia en cosecha"
        },
        "🫒 Pistacho": {
            "gdd_base":    10,
            "gdd_optimo":  (2500, 3500),
            "precip_opt":  (200, 500),
            "frio_horas":  (800, 1200),
            "estres_temp": 45,
            "densidad_def": 300,
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Alta tolerancia al calor y sequía, sensible a humedad excesiva"
        },
        "🌸 Almendro": {
            "gdd_base":    7,
            "gdd_optimo":  (1400, 2000),
            "precip_opt":  (300, 600),
            "frio_horas":  (300, 700),
            "estres_temp": 40,
            "densidad_def": 500,
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Floración temprana, muy sensible a heladas tardías"
        },
        "🟣 Ciruelo": {
            "gdd_base":    7,
            "gdd_optimo":  (900, 1400),
            ...
            "unidad":      "kg/ha",
            "indices":     ["EVI", "NDWI", "NDRE"],
            "nota":        "Gran variabilidad varietal, sensible a déficit en engorde"
        },
    }
    # ================================
    # ESTADOS
