...
if menu == "🛰️ Rend. Inteligente":
    ...
    # ================================
    # 1️⃣ MAPA PARA DIBUJAR POLÍGONO
    # ================================
    ...
    if len(ndvi_vals) >= 3:
        ...
        vis = {'min':0, 'max':200, 'palette':['blue','yellow','red']}
        map_id_rend = ee.data.getMapId({'image': rend_est.visualize(**vis)})
